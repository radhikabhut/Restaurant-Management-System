...
func CreateOrder(ctx *gin.Context) {
	...
	var reqPay handler.CreateOrderRequest
	var resPay handler.CreateOrderResponse
	...
	if err := handler.CreateOrder(req); err != nil {
		slog.Error("error while creating order", "error", err.Error())
